    ...
    where T : notnull
{
    ...
    public virtual T VisitAst(Ast node)
    {
        switch (node)
        {
            case Ast.Unit x: return VisitUnit(x);
            case Ast.Decl x: return VisitDecl(x);
            case Ast.Expr x: return VisitExpr(x);
            case Ast.Type x: return VisitType(x);
    ...
    public virtual T VisitDecl(Ast.Decl node)
    {
        switch (node)
        {
            case Ast.Decl.Binding x: return VisitBindingDecl(x);
            default: throw new UnreachableException();
        }
    }
    ...
    public virtual T VisitExpr(Ast.Expr node)
    {
        switch (node)
        {
            case Ast.Expr.Unit x: return VisitUnitExpr(x);
            case Ast.Expr.UndefinedLiteral x: return VisitUndefinedLiteralExpr(x);
            case Ast.Expr.BoolLiteral x: return VisitBoolLiteralExpr(x);
            case Ast.Expr.IntLiteral x: return VisitIntLiteralExpr(x);
            case Ast.Expr.Identifier x: return VisitIdentifierExpr(x);
            case Ast.Expr.Func x: return VisitFuncExpr(x);
            case Ast.Expr.If x: return VisitIfExpr(x);
            case Ast.Expr.Call x: return VisitCallExpr(x);
            case Ast.Expr.Let x: return VisitLetExpr(x);
            case Ast.Expr.Tuple x: return VisitTupleExpr(x);
            case Ast.Expr.List x: return VisitListExpr(x);
            case Ast.Expr.Annotated x: return VisitAnnotatedExpr(x);
            default: throw new UnreachableException();
        }
    }
    ...
    public virtual T VisitType(Ast.Type node)
    {
        switch (node)
        {
            case Ast.Type.Unit x: return VisitUnitType(x);
            case Ast.Type.Int x: return VisitIntType(x);
            case Ast.Type.Bool x: return VisitBoolType(x);
            case Ast.Type.Func x: return VisitFuncType(x);
            case Ast.Type.Tuple x: return VisitTupleType(x);
            case Ast.Type.List x: return VisitListType(x);
            case Ast.Type.Var x: return VisitVarType(x);
            default: throw new UnreachableException();
        }
    }
